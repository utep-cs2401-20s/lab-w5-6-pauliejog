...
public class SnakeGame {
    ...
    public int[] findTailExhaustive() {
        ...
        int snakeLen = 0;//increment every time piece is part of snake (true)
    ...
    public int[] findTailRecursive(int[] currentPosition, int[] previousPosition) {
        ...
        if(neighbors(currentPosition[0],currentPosition[1]) == 1 &&
            ...
            result[2] = recursiveChecks;//recursiveChecks and snakeLen should be the same since method only checks snake :))))
            return result;
    ...
    /*
    * neighborsPosition method:
    * This method finds the next unchecked snake piece and returns its position.
     */
    ...
    public void printBoard() {//prints the snake board
